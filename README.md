<p style="font-size:100px;">Demon Slayer - Anime Website</p>
...
## 🚀 Live Demo
🔗 https://nayan286.github.io/DEMON-SLAYER/
...
- Grid pixel effect  
- Grid box random fade animation during page transitions  
- Loader with aesthetic visuals and background music  
...
```bash
git clone https://github.com/Nayan286/DEMON-SLAYER.git
cd DEMON-SLAYER
